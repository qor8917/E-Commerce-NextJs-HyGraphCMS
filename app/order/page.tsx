...
export default function Order() {
  return (
    <div className="relative z-0 bg-white font-sodo-sans leading-snug text-black lg:pt-[6.1876rem] pt-[5rem]">
      {/* 타이틀 */}
      <div className="fixed bottom-0 left-0 top-0 z-10 flex min-w-[40%] flex-col items-start justify-between bg-[#1E3932] px-10 pt-[99px] text-white max-lg:relative max-lg:justify-start max-lg:px-4 max-lg:py-2 max-lg:min-w-full">
        ...
        <div className="flex justify-center flex-col items-center gap-y-4">
          ...
          <div className="w-[80%] max-xl:min-w-full pt-4">
            <div className="p-4 flex flex-col gap-y-2">
              ...
              <div className=" opacity-80 text-gray-500">
